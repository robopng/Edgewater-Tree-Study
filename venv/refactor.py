...
for name in os.listdir('./src/inputs'):
    with open(f'./src/inputs/{name}.csv',mode='r') as input:
        # skip the header
        input.readline()
        with open(f'./src/outputs/{name}_sorted.csv',mode='w') as output:
